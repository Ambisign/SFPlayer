    ...
    public partial class Form5 : Form
    {
        ...
        private void Form5_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                for (int i = 0; i <= 20; i++)
                {
                    firewallPolicyDel.Rules.Remove("StoreAndForwardPlayer");
                }
                ...
                for (int i = 0; i <= 20; i++)
                {
                    firewallPolicyDel1.Rules.Remove("UpdateStoreAndForwardPlayer");
                }

                INetFwRule firewallRule = (INetFwRule)Activator.CreateInstance(Type.GetTypeFromProgID("HNetCfg.FWRule"));
                firewallRule.Action = NET_FW_ACTION_.NET_FW_ACTION_ALLOW;
                firewallRule.Description = "Allow notepad";
                firewallRule.ApplicationName = Application.StartupPath + "\\StoreAndForwardPlayer.exe";
                firewallRule.Enabled = true;
                firewallRule.InterfaceTypes = "All";
                firewallRule.Name = "StoreAndForwardPlayer";
                ...
                firewallRule1.ApplicationName = Application.StartupPath + "\\UpdateStoreAndForwardPlayer.exe";
                firewallRule1.Enabled = true;
                firewallRule1.InterfaceTypes = "All";
                firewallRule1.Name = "UpdateStoreAndForwardPlayer";
