...
namespace StoreAndForwardPlayer
{
    public partial class frmStart : Form
    {
        ...
        private void frmStart_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                Link.Update(Environment.SpecialFolder.Desktop, Application.ExecutablePath, "StoreAndForwardPlayer", false);
                Link.Update(Environment.SpecialFolder.Desktop, Application.ExecutablePath, "StoreAndForwardPlayer", true);
